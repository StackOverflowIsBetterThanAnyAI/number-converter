...
static std::string convertDecToHex(int num) {
	if (num == 10) {
		return "A";
	}
	if (num == 11) {
...
static std::string convertHexToDec(std::string str) {
	if (str == "A") {
		return "10";
	}
	if (str == "B") {
...
static std::string decimalToHex(int num, std::string bit) {
	int q = num / 16;
	int r = num - q * 16;
...
static std::string decimalToBinary(int num, std::string bit) {
	int q = num / 2;
	int r = num - q * 2;
...
static std::string hexToDecimal(std::string str) {
...
static std::string hexToBinary(std::string str) {
	return decimalToBinary(std::stoi(hexToDecimal(str)), "");
}

static std::string binaryToDecimal(std::string str) {
	int result = 0;
...
static std::string binaryToHex(std::string str) {
...
static std::string calculateOutput(
...
static std::string validateFormat(std::string question) {
...
static std::string validateInput(std::string formatFrom) {
	while (true) {
		try {
